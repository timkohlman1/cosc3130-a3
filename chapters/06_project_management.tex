...
The scope of the project is to develop a research proposal that designs a context-aware multimodal misinformation detection framework based on DANES/GETAE models.
